...
export const CLOUDINARY_FOLDER = process.env.CLOUDINARY_FOLDER; // Optional, defaults to 'medusa-media'
...
/**
 * (required) Paystack API keys - Primary payment provider
 */
export const PAYSTACK_SECRET_KEY = process.env.PAYSTACK_SECRET_KEY;
export const PAYSTACK_PUBLIC_KEY = process.env.PAYSTACK_PUBLIC_KEY;

/**
 * (optional) Flutterwave API keys - Alternative payment provider
 */
...
export const GOOGLE_CALLBACK_URL = process.env.GOOGLE_CALLBACK_URL || (BACKEND_URL ? `${BACKEND_URL}/oauth/google/callback` : undefined);
